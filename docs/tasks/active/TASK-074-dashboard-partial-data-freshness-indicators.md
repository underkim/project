# TASK-074: Dashboard Partial Data Freshness Indicators
...
## 1. Goal
Dashboard cards should communicate freshness during partial failures. This improves existing feature correctness and day-to-day usability without adding unrelated scope.

## 2. Requirements
- In scope: inspect the current dashboard workflow and implement the smallest safe improvement that satisfies the goal.
...
- Files reviewed: app/modules/dashboard/router.py, app/modules/dashboard/service.py, frontend/app/(dashboard)/page.tsx.
