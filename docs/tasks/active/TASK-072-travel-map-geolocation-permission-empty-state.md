# TASK-072: Travel Map Geolocation Permission Empty State
...
## 1. Goal
Travel map location flows should handle denied geolocation. This improves existing feature correctness and day-to-day usability without adding unrelated scope.

## 2. Requirements
- In scope: inspect the current travel workflow and implement the smallest safe improvement that satisfies the goal.
...
- Files reviewed: app/modules/travel/router.py, app/modules/travel/service.py, frontend/app/(dashboard)/travel/page.tsx.
