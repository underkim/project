# TASK-080: Frontend Environment Configuration Validation
...
## 1. Goal
Frontend public runtime configuration should fail safely when missing. This improves existing feature correctness and day-to-day usability without adding unrelated scope.

## 2. Requirements
- In scope: inspect the current frontend workflow and implement the smallest safe improvement that satisfies the goal.
...
- Files reviewed: frontend/app/(dashboard)/*/page.tsx, frontend/lib/api.ts, frontend/types/index.ts.
