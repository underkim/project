# TASK-065: AI Execute Action Idempotency Key
...
## 1. Goal
AI action execution should avoid duplicate mutations. This improves existing feature correctness and day-to-day usability without adding unrelated scope.
