# TASK-059: Career Rating Trend Empty and Error States
...
## 1. Goal
Career rating charts should handle empty and failed loads. This improves existing feature correctness and day-to-day usability without adding unrelated scope.

## 2. Requirements
- In scope: inspect the current career workflow and implement the smallest safe improvement that satisfies the goal.
...
- Files reviewed: app/modules/career/router.py, app/modules/career/service.py, frontend/app/(dashboard)/career/page.tsx.
