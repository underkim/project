# TASK-079: Backend Healthcheck Dependency Mode
...
## 1. Goal
Health checks should distinguish process health from dependency readiness. This improves existing feature correctness and day-to-day usability without adding unrelated scope.
