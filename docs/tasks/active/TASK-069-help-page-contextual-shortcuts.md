# TASK-069: Help Page Contextual Shortcuts
...
## 1. Goal
The help page should link to common workflows. This improves existing feature correctness and day-to-day usability without adding unrelated scope.
