# TASK-064: AI Weekly Report Loading and Cache State
...
## 1. Goal
Weekly report generation should show clear loading and retry states. This improves existing feature correctness and day-to-day usability without adding unrelated scope.

## 2. Requirements
- In scope: inspect the current ai workflow and implement the smallest safe improvement that satisfies the goal.
...
- Files reviewed: app/modules/ai/router.py, app/modules/ai/service.py, frontend/components/AiModal.tsx.
