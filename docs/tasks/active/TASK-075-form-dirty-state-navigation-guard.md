# TASK-075: Form Dirty State Navigation Guard
...
## 1. Goal
Forms should warn before losing unsaved edits. This improves existing feature correctness and day-to-day usability without adding unrelated scope.
