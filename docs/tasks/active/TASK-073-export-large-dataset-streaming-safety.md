# TASK-073: Export Large Dataset Streaming Safety
...
## 1. Goal
Large CSV exports should remain reliable and scoped. This improves existing feature correctness and day-to-day usability without adding unrelated scope.

## 2. Requirements
- In scope: inspect the current export workflow and implement the smallest safe improvement that satisfies the goal.
...
- Files reviewed: app/modules/export/router.py, app/modules/export/service.py, frontend/lib/api.ts.
