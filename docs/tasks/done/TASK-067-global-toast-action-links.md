# TASK-067: Global Toast Action Links
...
## 1. Goal
Toasts should support accessible safe action links. This improves existing feature correctness and day-to-day usability without adding unrelated scope.
